...
apt-get install -y aptitude tasksel synaptic gksu git-core build-essential software-properties-common python-software-properties python-dev cmake ca-certificates 
...
apt-get upgrade -y
#add extra packages
apt-get install -y --no-install-recommends gdm gnome-core nautilus network-manager vim tmux zsh unzip openssh-server  
#firefox form mozila
